...
## m.7H2 295.4   6.3   0.0   0.56 10.18  NA
## m.7H1 295.8   6.6   0.4   0.44 10.42 0.4
```
...
```
##       WAIC pWAIC dWAIC weight    SE   dSE
## m.c3 463.5   4.7   0.0   0.81 14.96    NA
## m.c2 466.3   4.0   2.9   0.19 14.18  3.31
## m.c1 536.1   2.6  72.6   0.00 13.36 15.18
```
...
```
##        Mean StdDev  5.5% 94.5%
## a     -3.90   1.95 -7.01 -0.80
## bS     0.14   0.06  0.06  0.23
...
```
##        WAIC pWAIC dWAIC weight    SE  dSE
## m.1.1 267.9   3.7   0.0   0.58 15.06   NA
## m.1.2 268.5   5.1   0.6   0.42 15.94 3.44
```
...
```
##        WAIC pWAIC dWAIC weight    SE  dSE
## m.2.1 274.0   4.2   0.0   0.51 17.25   NA
## m.2.2 274.2   5.5   0.1   0.49 17.23 3.86
```
...
```
##        WAIC pWAIC dWAIC weight    SE  dSE
## m.3.1 261.7   6.1   0.0   0.72 16.15   NA
## m.3.2 263.6   7.0   1.9   0.28 16.37 0.57
```
